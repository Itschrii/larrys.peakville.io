// Script di test semplificato per verificare la creazione degli ordini
...
async function testOrderCreation() {
  try {
    console.log('🧪 Test creazione ordini (versione semplificata)...\n');
    ...
    const orderActivity = activities.find(activity => 
      activity.activity_type === 'order' && activity.item_name === testItem.name
    );
